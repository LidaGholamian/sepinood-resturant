...
import { orderStatusClasses } from "../constants/order-status.constants";
    ...
    <Card className="bg-forest-700 border-none text-cream-100 w-full mx-auto max-w-md">
      ...
      <CardContent className="space-y-3">
        ...
        <Link
          ...
          className="block text-center bg-forest-600 py-2 rounded-md text-cream-100 hover:text-cream-100/80 hover:bg-forest-500 transition-colors"
        >
          مشاهده جزئیات سفارش
        </Link>
      </CardContent>
